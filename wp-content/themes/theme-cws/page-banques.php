	...
	<div class="container-fluid">
		...
		<div class="row row-eq-height">
			<div class="col-md-8 block-left">
				<h2 class="block-title-template"><?php echo nl2br(get_post_meta(get_the_ID(),'cws_institution_financiere_title', true)); ?></h2>
				<p class="text-left">
					<?php echo nl2br(get_post_meta(get_the_ID(),'cws_institution_financiere', true)); ?>
				</p>
			</div>
			<div class="col-md-4 bg-color contact-entreprise">
				<h2 class="block-title-template"><?php echo nl2br(get_post_meta(get_the_ID(),'cws_espace_institution_title', true)); ?></h2>
				<p class="contact-cws">
